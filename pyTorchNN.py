# 0.0234 becomes 0.0203 https://www.kaggle.com/wxxiao33/pttest

from subprocess import call
import os

FNULL = open(os.devnull, 'w')
call("pip install https://github.com/ceshine/pytorch_helper_bot/archive/0.0.1.zip".split(" "), stdout=FNULL,
     stderr=FNULL)
...
class MLPModel(nn.Module):
    def __init__(self, num_features):
        ...
        self.model = nn.Sequential(
            weight_norm(nn.Linear(num_features, 256)),
            nn.Hardtanh(),
...
for train_index, valid_index in kf.split(x_train):
    ...
    bot.train(
        ...
        early_stopping_cnt=100, scheduler=scheduler)
